(function (global, factory) {
  ...
  var randomIntegral = function (options) {
  ...
  var randomNatural = function (options) {
  ...
  var randomChar = function (options) {
  ...
  var randomSyllable = function (options) {
  ...
  var randomLorem = function (options) {
  ...
  var randomIndex = function (options) {
  ...
  var randomTld = function () {
    return pickItem(tldList);
  };

  var randomDomains = function (options) {
  ...
  var randomEmail = function (options) {
    var domain = options && options.domain
      ? toStr(options.domain)
      : randomDomains();
